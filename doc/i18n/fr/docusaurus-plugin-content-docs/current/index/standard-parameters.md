...
| _response_file_         | Entrée / Sortie | byte[]    | Brut                                                                                               | VARBINARY(MAX)  | Le fichier allant être inclus dans la réponse.                                                                                                                                              |
| _response_file_name_    | Entrée / Sortie | string    | Brut                                                                                               | NVARCHAR(MAX)   | Le nom du fichier allant être inclus dans la réponse.                                                                                                                                       |
| _response_file_inline_  | Entrée / Sortie | bool      |                                                                                                    | BIT             | Vrai si le fichier doit-être ouvert dans la visionneuse du navigateur.                                                                                                                      |
