...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_components_get]
...
BEGIN
    ...
    EXEC [sqliste].[p_openapi_3_0_schema_json_create_components_def] @json = @json OUT;
END
GO

CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_add_property_def]
...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_add_type_def]
    @type_def_json NVARCHAR(MAX) OUT,
    @json NVARCHAR(MAX) OUT
AS
BEGIN
...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_create_array_property_def]
    @name NVARCHAR(MAX),
...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_create_components_def]
    @json NVARCHAR(MAX) OUT
AS
BEGIN
    SET @json = '{ "schemas": {} }';
...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_create_property_def]
    @name NVARCHAR(MAX),
    @type NVARCHAR(MAX),
    @required BIT = 0,
    @min_length INT = NULL,
...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_create_property_ref]
    @name NVARCHAR(MAX),
...
CREATE OR ALTER PROCEDURE [sqliste].[p_openapi_3_0_schema_json_create_type_def]
    @name NVARCHAR(MAX),
...
CREATE   PROCEDURE  [sqliste].[p_openapi_convert_type_sql_to_openapi]
...
BEGIN
    ...
    EXEC [sqliste].[p_openapi_3_0_components_get] @json = @component_json OUT;
